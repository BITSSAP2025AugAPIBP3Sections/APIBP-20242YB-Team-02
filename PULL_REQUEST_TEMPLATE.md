...
- [ ] 💥 Breaking change (existing functionality may be affected)
- [ ] 📝 Documentation update
- [ ] 🎨 UI/UX or styling change (non-functional)
- [ ] ♻️ Code refactoring (no functional change)
- [ ] ⚡ Performance improvement
- [ ] 🧪 Test update (unit/integration tests)
- [ ] 🔧 Configuration change
- [ ] 🏗️ DevOps/Build update (Docker, CI/CD, Kubernetes, Supabase config)
